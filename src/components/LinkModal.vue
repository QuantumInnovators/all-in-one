      ...
      <div class="modal-body">
        <div class="add-link-form">
          ...
          <div class="form-group">
            ...
            <input type="text" id="linkName" v-model="newLink.name" placeholder="链接名称" />
          </div>
          <div class="form-group">
            <label for="linkUrl">URL</label>
            <input type="text" id="linkUrl" v-model="newLink.url" placeholder="https://example.com" />
          </div>
          <div class="form-group">
            <label for="linkDesc">描述</label>
            <input type="text" id="linkDesc" v-model="newLink.description" placeholder="简短描述" />
          </div>
          <div class="form-group">
            <label for="linkIcon">图标</label>
            <select id="linkIcon" v-model="newLink.icon">
          ...
          <button class="add-button" @click="addLink">添加链接</button>
        </div>
        ...
        <div class="user-links-list">
          ...
          <div v-else class="links-list">
            <div v-for="(link, index) in userLinks" :key="index" class="link-item">
              ...
              <button class="delete-button" @click="deleteLink(index)">
                <NavIcon name="x" />
              </button>
            </div>
          </div>
